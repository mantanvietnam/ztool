...
import { 
    ...
    FiUsers, FiTarget, FiXCircle, FiPhone, FiMail, 
    FiFacebook, FiYoutube, FiGlobe 
} from 'react-icons/fi';

// === CẤU HÌNH DỮ LIỆU BẢNG GIÁ (6 GÓI) ===
interface Package {
    name: string;
    interactions: number;
    price: number;
...
export default function LandingPage() {
    return (
        <div className="bg-gray-900 text-white min-h-screen flex flex-col">
            {/* === HERO SECTION === */}
            <section className="text-center py-20 md:py-28 bg-gradient-to-b from-gray-900 to-gray-800">
             ...
             <section className="py-20 bg-gray-800/50 border-y border-gray-800">
                <div className="container mx-auto px-6">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div className="rounded-xl overflow-hidden shadow-2xl border border-gray-700 relative w-full aspect-video">
                            {/* ✨ CẬP NHẬT: Video mới */}
                           <iframe 
                                width="100%" 
                                height="100%" 
            ...
            <section id="pricing" className="py-20 bg-gray-800">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold">Bảng Giá Linh Hoạt</h2>
                    ...
                    {/* ✨ ĐÃ XÓA: Phần liên hệ tư vấn trực tiếp ở đây theo yêu cầu */}
                </div>
            </section>

             {/* === FINAL CTA SECTION === */}
            <section className="text-center py-20 pb-24">
                <div className="container mx-auto px-6">
